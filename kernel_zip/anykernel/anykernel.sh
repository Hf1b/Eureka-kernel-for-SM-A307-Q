...
# Edit for A30s by @chatur27 on XDA
## AnyKernel setup
# begin properties
properties() { '
kernel.string=
...
cp /tmp/anykernel/tools/a30s_changelog.txt /data/media/0/a30s_changelog.txt;
chmod 755 /data/media/0/a30s_changelog.txt;
...
ui_print "- A30s_changelog.txt has been copied to your";
