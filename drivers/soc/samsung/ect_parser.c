...
static int ect_parse_dvfs_domain(int parser_version, void *address, struct ect_dvfs_domain *domain)
{
	...
	if (domain->max_frequency == 2288000) //for big cores
		domain->max_frequency = 2288000;
	else if (domain->max_frequency == 2184000) //for big cores
		domain->max_frequency = 2288000;
...
static int ect_parse_ap_thermal_function(int parser_version, void *address, struct ect_ap_thermal_function *function)
{
	...
	for (i = 0; i < function->num_of_range; ++i) {
		...
		if (range->max_frequency == 2288000) //for big cores
			range->max_frequency = 2184000;
		else if (range->max_frequency == 2184000) //for big cores
			range->max_frequency = 2184000;
